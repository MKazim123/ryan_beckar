					...
					while ( have_posts() ) {
                        ...
                        if($post_id != 788){
                            ...
                            <div id="custom-bg" style="background-image: url(<?php echo $image[0]; ?>);">
                                <?php echo '<h1 class="single_title">'.rtrim(get_the_title());'</h1>' ?>
                            </div>
                            ...
                            ?>
                            <div id="custom-bg" style="background-image: url(<?php echo $image[0]; ?>);">
                                <?php echo '<h1 class="single_title">Altruistically Germane Not Defective or Feig<span class="last-letter-small">n</span></h1>' ?>
                            </div>
                            ...
                            <div class="single_content_divider">
                                ...
                                <div class="single_sec_right">
                                    <div class="single_meta_info">
                                        ...
                                        <p class="published_date"><?php echo get_the_date(); ?></p>
                                        <?php
                                        if(has_category()){
                                        ...
                                        $random_col = array('#70D4B6','#AAC581','#B0456F','#D45928');
                                        $tags = get_the_tags();
                                        ...
                                        foreach($tags as $tag){
                                            ...
                                            if($count == sizeof($tags) - 1){
                                                echo '<span style="color:'.$random_col[$k].'">'.$tag->name.'</span>';
                                            }else{
                                                echo '<span style="color:'.$random_col[$k].'">'.$tag->name.', </span>';
                                            }
                                            $count++;
